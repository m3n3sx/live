...
(function($) {
    ...
    const MAS = {
        ...
        init: function() {
            console.log('🚀 MAS V2: Initializing Modern Admin Styler V2...');
            ...
            console.log('✅ MAS V2: Modern Admin Styler V2 initialized successfully');
        ...
        initServerMonitoring: function() {
            console.log('🔍 PRIORYTET 3: Initializing server monitoring...');
        ...
        optimizeMemoryUsage: function() {
            console.log('🧠 PRIORYTET 3: Optimizing memory usage...');
